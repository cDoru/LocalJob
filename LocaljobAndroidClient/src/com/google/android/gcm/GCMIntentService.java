  ...
  protected void onMessage(Context context, Intent intent) {
    ...
    if (extras != null)
    {
    	...
    	if (foreground)
    		...
    		this.onReceiveModded(context, extras);
    }
  }
  
//Codice aggiunto da me! 
  
  public void onReceiveModded(Context context, Bundle extras) {
	  String message = extras.getString("message");
	  String title = extras.getString("title");
	  //Notification notif = new Notification(android.R.drawable.btn_star_big_on, message, System.currentTimeMillis() );
	  Notification notif = new Notification(android.R.drawable.btn_star_big_on, "Hai un nuovo messaggio", System.currentTimeMillis() );
	 ...
	 // notif.setLatestEventInfo(context, title, message, contentIntent);
	  notif.setLatestEventInfo(context, "LocalJob", "Hai un nuovo messaggio", contentIntent);
